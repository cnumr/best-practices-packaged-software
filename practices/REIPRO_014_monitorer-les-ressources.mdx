...
saved_resources:
  ...
  - network
validations:
  - de projets avec suivi des consommations systèmes des clients
    maxValue: '90%'
  - de clients ayant des alertes sur la sur ou sous consommation système et/ou projections de consommation
    maxValue: '90%'
---
