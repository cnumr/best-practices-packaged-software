...
updatedAt: 2025-12-19T14:51:59.586Z
language: fr
published: true
refType: RWP
versions:
...
* la présence de l'hébergeur sur la liste des entreprises référencées comme conformes :
  * au [Code de Conduite européen \*\[E3P\]: European Energy Efficiency Platform sur les datacenters](https://web.archive.org/web/20240918212256/https://e3p.jrc.ec.europa.eu/node/575) (archive) ;
