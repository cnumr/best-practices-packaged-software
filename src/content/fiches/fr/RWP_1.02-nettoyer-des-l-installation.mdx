...
updatedAt: 2025-12-19T14:23:35.519Z
language: fr
published: true
refType: RWP
versions:
...
Par défaut, WordPress comprend déjà un certain nombre de fonctionnalités (gestion des pages, des articles et de leurs catégories, des commentaires, des médias et des utilisateurs). Lors de l'installation, celui-ci embarque également les 4 derniers thèmes "TwentyTwentyXXXX", tous compatibles avec son constructeur de pages natif Gutenberg, et 2 extensions (Akismet, Hello Dolly).

En décembre 2025 ([version 6.9.3 en français](https://fr.wordpress.org/latest-fr_FR.zip)), WordPress représente un grand nombre de fichiers qui pesant environ 96,6 Mo sur l'hébergement. 
...
* L'extension Hello Dolly peut être supprimée, elle n'apporte aucune fonctionnalité essentielle (Hello Dolly sert d'inspiration à la création de ses premiers plugins basiques).
...
**Pour désactiver les Emojis**, vous pouvez créer une extenstion incluant le code présenté dans "Solution code pas-à-pas"  de cette page. Attention à [respecter les conventions de codage des extensions](https://developer.wordpress.org/plugins/plugin-basics/) (vous pouvez vous inspirez de Hello Dolly ou Akismet).
