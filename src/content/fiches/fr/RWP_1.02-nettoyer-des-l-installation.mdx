...
updatedAt: 2025-12-19T14:31:05.274Z
language: fr
published: true
refType: RWP
versions:
...
En décembre 2025 ([version 6.9.3 en français](https://fr.wordpress.org/latest-fr_FR.zip)), WordPress représente un grand nombre de fichiers, et pèse environ 96,6 Mo sur l'hébergement. 
